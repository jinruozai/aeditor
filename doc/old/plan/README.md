...
| [2026-05-perfect-state/02-ui-cleanup-contract.md](./2026-05-perfect-state/02-ui-cleanup-contract.md) | aiditor.ui cleanup rules, compound components, virtualization, overlays | Draft |
...
- Changes to `src/` require rebuilding `dist/aiditor.js` and `dist/aiditor.css`.
