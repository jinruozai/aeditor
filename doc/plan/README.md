# editorframe optimization plans
...
| [2026-05-perfect-state/02-ui-cleanup-contract.md](./2026-05-perfect-state/02-ui-cleanup-contract.md) | EF.ui cleanup rules, compound components, virtualization, overlays | Draft |
...
- Changes to `src/` require rebuilding `dist/ef.js` and `dist/ef.css`.
