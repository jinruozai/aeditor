...
- Updates stale `EF.errors/error-log/errors.js` references
- Documents `EF.log`
...
- Adds default `EF.ui.dispose` fallback
...
2. default `EF.ui.dispose` fallback in component runtime disposal
