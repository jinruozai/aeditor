...
- 写 dev server 时用 `.Codex/launch.json` 已配好的 `ef-demo`(端口 5570),不要自己拉新端口
...
**下一步给下个 Codex 的提示**:
- 进项目第一件事:`node tools/build.mjs --watch` + `.Codex/launch.json` 的 `ef-demo`(端口 5570)
